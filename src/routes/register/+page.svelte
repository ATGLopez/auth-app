    ...
    <form class="m-4" method="POST">
        <div class="sm:col-span-4">
            ...
            <div class="mt-2">
                <div class="flex items-center rounded-md bg-white">
                    <input 
                        ...
                        placeholder="Enter your username here." class="block rounded-md" 
                    />
                </div>
            </div>
            ...
            <div class="mt-2">
                <div class="flex items-center rounded-md bg-white">
                    <input 
                        ...
                        placeholder="Enter your password here." class="block rounded-md" 
                    />
                </div>
            </div>
            ...
            <div class="mt-2">
                <div class="flex items-center rounded-md bg-white">
                    <input 
                        id="confirm_pass" type="password" name="confirm_pass" autocomplete="new-password"
                        placeholder="Confirm your password here." class="block rounded-md" 
                    />
                </div>
            </div>
        </div>
